...
public class TonyPanel extends javax.swing.JPanel {
    ...
    private void githubMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_githubMouseClicked
        try{
             Desktop.getDesktop().browse(new URL("https://github.com/tonytoes").toURI());
         }catch(Exception e){}
    ...
    private void facebookMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_facebookMouseClicked
        try{
             Desktop.getDesktop().browse(new URL("https://www.facebook.com/tonywhirrr").toURI());
         }catch(Exception e){}
