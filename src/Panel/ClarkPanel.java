...
public class ClarkPanel extends javax.swing.JPanel {
    ...
    private void facebookMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_facebookMouseClicked
        try{
             Desktop.getDesktop().browse(new URL("https://www.facebook.com/clarkderick.custodio.79").toURI());
         }catch(Exception e){}
