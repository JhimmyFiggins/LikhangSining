...
public class ElaizaPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        pH_Label1.setAA_CompImage(new javax.swing.ImageIcon(getClass().getResource("/Images/elaiza.jpg"))); // NOI18N
        pH_Label1.setAA_DrawImage(true);

        name.setFont(new java.awt.Font("OCR A Extended", 1, 18)); // NOI18N
        name.setForeground(new java.awt.Color(255, 255, 255));
        name.setText("Elainza Bugayong");
    ...
    private void facebookMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_facebookMouseClicked
        try{
             Desktop.getDesktop().browse(new URL("https://www.facebook.com/elaiza.bugayong.7").toURI());
         }catch(Exception e){}
