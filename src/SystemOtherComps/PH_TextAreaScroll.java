...
public class PH_TextAreaScroll extends JScrollPane {
    ...
    private Color AA_scrollBarBackground = Color.BLACK;
    private Color AA_scrollBarForeground = Color.BLACK;
    
    public PH_TextAreaScroll() {
        setVerticalScrollBar(new PH_ScrollBar());
        PH_ScrollBar scrol = new PH_ScrollBar();
        scrol.setBackground(AA_scrollBarBackground);
        scrol.setForeground(AA_scrollBarForeground);
