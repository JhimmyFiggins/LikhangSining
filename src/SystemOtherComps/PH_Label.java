...
public class PH_Label extends JLabel {
    ...
    public Color getAA_LabelColor() {
        return AA_LabelColor;
    }
    
    public void setAA_LabelColor(Color AA_LabelColor) {
        this.AA_LabelColor = AA_LabelColor;
    }
    ...
    private Color AA_LabelColor = Constants.UI_Default_CompButtonColor;
    ...
    private boolean AA_OpaqueBackground = Constants.UI_Default_OpaqueBackgroundTrue;
