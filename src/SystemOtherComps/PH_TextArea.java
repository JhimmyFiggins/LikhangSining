...
public class PH_TextArea extends JTextArea {

    private PH_TextAreaScroll scroll;
    ...
    public PH_TextArea() {
        ...
        setBackground(Constants.UI_Default_CompButtonColor);
    ...
    private PH_TextAreaScroll getScroll() {
        if (scroll == null) {
            Component com = getParent();
            JViewport view = (JViewport) com;
            scroll = (PH_TextAreaScroll) view.getParent();
        }
        return scroll;
    }
}
